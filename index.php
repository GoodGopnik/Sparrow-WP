            ...
            ?>
               <article class="row entry">
                  ...
                  <div class="entry-header">
                     ...
                     <div class="permalink">
                        <a href="<?php echo get_permalink();?>"><i class="fa fa-link"></i></a>
                     </div>
                     ...
                     <div class="two columns post-meta end">
                        <p>
                        <time datetime="2014-01-31" class="post-date" pubdate=""><?php the_time('d.m.Y'); ?></time>
                  ...
                  <div class="ten columns offset-2 post-content">
                     <p><?php the_excerpt();?>
                     <a class="more-link" href="<?php echo get_permalink();?>">Read More<i class="fa fa-arrow-circle-o-right"></i></a></p>
                  </div>
