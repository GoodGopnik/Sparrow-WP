         ...
         <div id="primary" class="eight columns">
            ...
            <section>
              ...
              <div id="contact-form">
                  ...
                  <!-- form -->
                  <form class="contacts__form" name="contactForm" id="contactForm" method="post" action="<?php echo admin_url('admin-ajax.php?action=send_mail') ?>">
      					<fieldset>

                     <div class="half">
      						   <label for="contactName">Name <span class="required">*</span></label>
      						   <input name="contactName" type="text" id="contactName" size="35" value="" required/>
                        </div>

                        <div class="half pull-right">
      						   <label for="contactEmail">Email <span class="required">*</span></label>
      						   <input name="contactEmail" type="text" id="contactEmail" size="35" value="" required/>
                        </div>
            ...
            <aside id="sidebar">
               ...
               <div class="widget widget_photostream">
                  ...
                  <ul class="photostream cf">
                     <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/thumb.jpg" alt="thumbnail"></a></li>
                     <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/thumb.jpg" alt="thumbnail"></a></li>
                     <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/thumb.jpg" alt="thumbnail"></a></li>
                     <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/thumb.jpg" alt="thumbnail"></a></li>
                     <li><a href="#"><img src="<?php echo get_template_directory_uri();?>/assets/images/thumb.jpg" alt="thumbnail"></a></li>
